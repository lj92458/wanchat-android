...
class MatrixTimelineItemMapperForDelete(
    ...
    private val eventTimelineItemMapper: EventTimelineItemMapperForDelete,
) {
    fun map(timelineItem: TimelineItem): MatrixTimelineItem = timelineItem.use {
        ...
        if (asEvent != null) {
            ...
            if (eventTimelineItem.hasNotLoadedInReplyTo() && eventTimelineItem.eventId != null) {
                eventTimelineItem.eventId?.let { eventId -> fetchEventDetails(eventId) }
            }
