...
object ApplicationConfig {
     ...
     * - "WanChat" for release builds;
     * - "Element X dbg" for debug builds;
     * - "Element X nightly" for nightly builds.
     */
    const val APPLICATION_NAME: String = "WanChat"

    /**
     * Used in the strings to reference the Element client.
     * Cannot be empty.
     * For WanChat, the value is "WanChat".
     */
    const val PRODUCTION_APPLICATION_NAME: String = "WanChat"

    /**
     * Used in the strings to reference the Element Desktop client, for instance Element Web.
     * Cannot be empty.
     * For Element, the value is "WanChat". We use the same name for desktop and mobile for now.
     */
    const val DESKTOP_APPLICATION_NAME: String = "WanChat"
}
