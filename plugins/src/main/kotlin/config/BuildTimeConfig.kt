...
object BuildTimeConfig {
    const val APPLICATION_ID = "info.wanchat.android"
    /** 这里一旦写死，就无法国际化。因此放到string.xml中了 */
    const val APPLICATION_NAME = "WanChat"
    ...
    val METADATA_HOST_REVERSED: String? = null //OAuth/OIDC（开放授权）登录流程中的“回跳地址”
